...
with open("keys_deed.txt" , "r" , encoding="utf-8") as f:
...
with open("keys_deed.txt", "a" , encoding="utf-8") as f:
        
        for index , key  in enumerate(new_keys_to_upload):
            f.writelines(key)
            f.writelines("\n")

with open("newkeys_deed.txt" , "w" , encoding="utf-8") as f :
...
with open("keys_deed.json" , "w" , encoding="utf-8" ) as f:
    ...
    for index , key  in enumerate(new_keys_to_upload):
        ...
        if document.startswith("company"):
            forgive(unique ,output[timeline_key][0])
