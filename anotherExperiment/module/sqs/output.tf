...
output "workflow_requests_sqs_queue_arn" {
    description = "sqs arn"
    value = aws_sqs_queue.workflow_requests.arn   
}
...
output "workflow_lambda2_trigger_sqs_queue_name" {
    description = "sqs_queue_name"
...
output "workflow_lambda3_trigger_sqs_queue_name" {
    description = "sqs_queue_name"
    value = aws_sqs_queue.workflow_lambda3_trigger.name
}


output "workflow_lambda3_trigger_sqs_queue_arn" {
    description = "sqs arn"
